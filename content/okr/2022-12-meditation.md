---
title: "202212_meditation"
date: 2022-12-01T07:17:00+08:00
draft: false
---
...
gantt
    ...
    强化学习选择语音引导词:2022-12-25,1d
    强化学习选择背景音乐:2022-12-25,1d
    强化学习之dataloader:2022-12-15,1d
    meditaion RL training debug:2022-12-15,4d
    冥想躲分类正常使用:2023-1-1,1d
    把中间的python服务用docker部署:done,2022-12-23,8d
    #花了3天时间解决torchaudio.load mp3出错。原因是需要apt install ffmepg 以及 import librosa
    #23号开始，受新冠影响，休息较多
    冥想，添加分类、自定义内容支持支持:done,2022-12-20,6d
    改进指令内容:done,2022-12-22,1d

    修复不使用背景音乐没有指令的Bug:done,2022-12-22,1d
    解决评价得分异常，有负数:done,2022-12-21,1d
    解决评价得分异常，没有考虑短程关联:done,2022-12-21,1d
    冥想音乐添加渐变，从而容许不同的音乐混合使用:done,2022-12-20,2d
    冥想，提供冥想曲线:done,2022-12-19,1d
    duration 改毫秒级精度，放弃，现在duraion 绑定的是背景音乐:done,2022-12-18,1d
    saavuu 添加通过函数改schema:done,2022-12-18,1d
    remove very short trajectory:done,2022-12-16,1d
    把最短连续状态设置为5s,以确采集的数据是连续的:done,2022-12-16,1d
    采集大量数据，以便训练神经网络:done,2022-12-13,3d
    通过更改mtu,使得手机能使用polarH10 加速度计,放弃，无法成功修改:done,2022-12-15,1d
    ...
    section devOps改进
    重写keydb的Dockerfile脚本，重新升级到更稳定的keydb:done,2022-12-15,1d
